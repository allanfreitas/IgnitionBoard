...
class IBB_Config extends CI_Config {
	...
	public final function initialize() {
		...
		if($CI->db->table_exists('config') == TRUE) {
...
//			}
	...
	private final function _init_defaults() {
		...
		require APPPATH . '/config/settings/database.php';
		...
		$this->database = new Config_Object($db);
		$this->paths = new Config_Object($paths);
		$this->board = new Config_Object($board);
	}
}
/**
